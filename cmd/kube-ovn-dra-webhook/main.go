...
func newApp() *cli.App {
	...
	app := &cli.App{
		Name:            "kube-ovn-dra-webhook",
		Usage:           "kube-ovn-dra-webhook implements a validating admission webhook complementing the kube-ovn NIC DRA driver plugin.",
		ArgsUsage:       " ",
